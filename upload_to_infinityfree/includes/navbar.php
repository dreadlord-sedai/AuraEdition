...
<nav class="w-full bg-black text-white border-b border-yellow-400/20 shadow-lg shadow-yellow-400/5">
    <div class="max-w-7xl mx-auto px-4 flex items-center justify-between py-4">
        <a class="logo text-3xl text-yellow-400 font-serif tracking-wider" href="/index.php" style="font-family: 'Trajan Pro', serif;">AuraEdition</a>
        ...
        <ul class="hidden md:flex space-x-8 list-none items-center m-0 p-0">
            ...
            <li><a class="nav-link text-white" href="/products/listings.php">Listings</a></li>
            <li><a class="nav-link text-white" href="/pages/categories.php">Makes</a></li>
            <li><a class="nav-link text-white" href="/pages/about.php">About</a></li>
            <li><a class="nav-link text-white" href="/pages/contact.php">Contact</a></li>
            <?php
            if (isset($_SESSION['user_id']) && $_SESSION['role'] === 'admin') {
                echo '<li><a class="nav-link text-white" href="/admin/dashboard.php">Dashboard</a></li>';
            }
            ?>
        </ul>
