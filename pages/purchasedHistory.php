    ...
    <div class="max-w-5xl mx-auto my-12 px-4">
        <div class="flex flex-col items-center gap-10">
            ...
            <div class="w-full max-w-3xl flex flex-col gap-6 rounded-xl bg-gray-900 border border-yellow-400/20 shadow-lg p-8">
                <h2 class="text-3xl font-serif text-yellow-400 mb-2" style="font-family: 'Trajan Pro', serif;">Purchased History</h2>
                ...
                $total_items = countPurchasedItemsByUserId($connection, $user_id);
                $total_pages = ceil($total_items / $items_per_page);
                $purchased_items = getPurchasedItemsByUserId($connection, $user_id, $items_per_page, $offset);

                if (empty($purchased_items)) :
                ?>
                    <p class="text-center text-gray-400">You have no purchased items.</p>
                <?php else : ?>
                    ...
                    ?>
                        <div class="flex flex-col md:flex-row justify-between gap-6 items-center rounded-lg bg-gradient-to-br from-black via-gray-900 to-gray-800 border border-yellow-400/10 p-6 w-full shadow">
                            ...
                            <div class="flex flex-col items-center flex-1 text-center">
                                ...
                                <div class="flex flex-row gap-2 items-center text-gray-300">
            ...
            <div class="flex flex-row gap-6 w-full justify-evenly p-6 my-4 border-y border-yellow-400/10">
                ...
                <div class="flex w-1/2 justify-center">
                    <a href="/Projects/AuraEdition/pages/wishlist.php" class="w-2/3 py-3 bg-gray-900 text-yellow-400 border border-yellow-400 rounded-lg hover:bg-yellow-400 hover:text-black transition text-lg text-center shadow">WISHLIST</a>
                </div>
            </div>
            <!-- Buttons -->
