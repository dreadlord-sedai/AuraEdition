        ...
        <div class="flex flex-col justify-content-center align-items-center gap-10">
            ...
            <div class=" cart-container flex flex-col w-75 flex-grow gap-3 justify-content-center rounded-lg align-items-center bg-gray-200 p-5">
                ...
                <?php else : ?>
                    ...
                    ?>
                        <div class="cart-item-row flex flex-row justify-between gap-3 items-center rounded-md bg-gray-400 p-4 w-full">
                            <img src="<?= htmlspecialchars($image) ?>" class="img-fluid object-fit-cover aspect-square w-40" alt="Product Image"> 
