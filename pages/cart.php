            ...
            <div class="w-full max-w-3xl flex flex-col gap-6 rounded-xl bg-gray-900 border border-yellow-400/20 shadow-lg p-8">
                ...
                <?php else : ?>
                    ...
                    <div class="flex flex-row justify-center items-center w-full mt-4">
                        <a href="/Projects/AuraEdition/process/cartCheckoutProcess.php" class="w-2/3 py-3 bg-yellow-400 text-black font-semibold rounded-lg hover:bg-yellow-500 transition text-lg text-center shadow">CHECKOUT</a>
                    </div>
                <?php endif; ?>
            </div>
            <!-- Cart Card -->
