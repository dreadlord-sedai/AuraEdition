            ...
            <div class=" cart-container flex flex-col w-75 flex-grow gap-3 justify-content-center rounded-lg align-items-center bg-gray-200 p-5">
                ...
                <?php else : ?>
                    ...
                    ?>
                        <div class="cart-item-row flex flex-row justify-between gap-3 items-center rounded-md bg-gray-400 p-4 w-full" data-price="<?= htmlspecialchars($item['price']) ?>">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                <button class="btn btn-outline-success" onclick="buyNow(<?= $item['vehicle_id'] ?>, parseInt(document.getElementById('quantity-<?= htmlspecialchars($item['cart_item_id']); ?>').textContent) || 1)" data-id="<?= $item['vehicle_id'] ?>">Buy Now</button>
                    ...
                    <div class="flex flex-row justify-center gap-3 items-center rounded-md bg-transparent p-4 w-full">
                        <a href="/Projects/AuraEdition/process/cartCheckoutProcess.php" class="btn btn-primary w-3/5">CHECKOUT</a>
                    </div>
                <?php endif; ?>
