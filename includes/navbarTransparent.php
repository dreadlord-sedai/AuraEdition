...
<nav class="absolute top-0 left-0 w-full z-30 text-white transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 flex items-center justify-between py-4">
        <a class="logo text-3xl text-yellow-400 font-serif tracking-wider" href="/Projects/AuraEdition/index.php" style="font-family: 'Trajan Pro', serif; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">AuraEdition</a>
        
        <!-- Main Navigation Links -->
        <ul class="hidden md:flex space-x-8 list-none items-center m-0 p-0">
            <li><a class="nav-link text-white" href="/Projects/AuraEdition/index.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">Home</a></li>
            <li><a class="nav-link text-white" href="/Projects/AuraEdition/products/listings.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">Listings</a></li>
            <li><a class="nav-link text-white" href="/Projects/AuraEdition/pages/categories.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">Makes</a></li>
            <li><a class="nav-link text-white" href="/Projects/AuraEdition/pages/about.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">About</a></li>
            <li><a class="nav-link text-white" href="/Projects/AuraEdition/pages/contact.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">Contact</a></li>
            <?php
            if (isset($_SESSION['user_id']) && $_SESSION['role'] === 'admin') {
                echo '<li><a class="nav-link text-white" href="/Projects/AuraEdition/admin/dashboard.php" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.4);">Dashboard</a></li>';
            }
            ?>
        </ul>
